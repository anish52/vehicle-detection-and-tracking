...
out = cv2.VideoWriter(OUTPUT_VIDEO_DIR+'\Full_Output_without_IDs.avi', fourcc, fps_out, (width,height))
...
def run_inference_for_video(model):
    ...
    while(True):
        ...
        with open(OUTPUT_VIDEO_DIR+"\\Full_Logs_without_IDs.txt", "a") as f:
